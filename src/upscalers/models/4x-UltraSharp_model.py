...
class UpscalerESRGAN(Upscaler):
    def __init__(self, dirname):
        self.name = "UltraSharp"
        self.model_url = "https://huggingface.co/Techbridge/ESRGAN_Models/resolve/main/ESRGAN/4x_UltraSharp_ESRGAN.pth"
        self.model_name = "4x_UltraSharp"
        self.scalers = []
